...
String testObjectPath = 'Page_Swag Labs/div_Sauce Labs Fleece Jacket'
...
println("Max Price Product Name: " + elementProductNameToText)

// Define the Test Object path
String testObjectPathDesc = 'Object Repository/Page_Swag Labs/div_Its not every day that you come across _897e84'

// Use WebUI.getText() to get the text of the element
String elementProductDescToText = WebUI.getText(findTestObject(testObjectPathDesc))

// Print the text to the console
println("Max Price Product Description: " + elementProductDescToText)
